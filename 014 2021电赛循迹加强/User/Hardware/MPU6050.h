...
short MPU6050_GetTemperature(void);//温度数据
unsigned char MPU6050_GetGyroscope(short *gx,short *gy,short *gz);//角速度数据
unsigned char MPU6050_GetAccelerometer(short *ax,short *ay,short *az);//加速度数据
